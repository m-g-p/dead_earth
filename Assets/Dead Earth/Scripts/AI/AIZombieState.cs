...
public abstract class AIZombieState : AIState
{
    ...
    // NOTE	:	In the Lesson 18 video I incorrectly used LayerMask.GetMask to
    //			fetch _bodyPartLayer where as I should have used LayerMask.NameToLayer.
    //			This is because we want the index of layer not the mass of the layer (oops)
    //			but this has been fixed below
    // -------------------------------------------------------------------------------------
    void Awake()
    {
